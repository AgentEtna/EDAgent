...
This file is maintained automatically by **Agent Etna** for **EDAgent**.
...
## Agent
- **Repo:** `Varn1t/EDAgent` (branch `main`)
...
- **safety:input-jailbreak** — A prompt update is the most direct and least invasive way to prevent the agent from using a specific forbidden term.
